"""
Django settings for Nsocial project.
...
SECRET_KEY = '5qcak#92ly5j8-am(q5d298c^_--82cn*bajjs*$if-&pgtjcp'
...
MIDDLEWARE = [
    ...
    'Nsocial.middleware.JWTMiddleware',
]

ROOT_URLCONF = 'Nsocial.urls'
...
WSGI_APPLICATION = 'Nsocial.wsgi.application'
